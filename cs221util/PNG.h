...
namespace cs221util {
    ...
    public:
         ...
         * @param points A vector of pairs {xi,yi} specifying the coordinates of the vertices.
         * @param edgeColour An RGBAPixel specifying the colour of the edges.
         * @param fillColour An RGBAPixel specifying the colour of the inner region.
         */
        void drawHexagon(vector<pair<int, int>> points, const RGBAPixel& edgeColour, const RGBAPixel& fillColour);

        /**
         * Colours the region bounded by edge_coords with specified colour.
         * @param start A point inside the inner region to start the fill.
         * @param fillColour An RGBAPixel specifying the colour to fill.
         * @param edge_coords A list of pairs {xi,yi} specifying the edges surrounding the filled region.
         */
